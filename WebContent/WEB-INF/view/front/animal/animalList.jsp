				...
				<div class="col-xl-3 col-lg-3 col-sm-12 col-xs-12 sidebar-shop-left">
					<div class="product-categori">
						<div class="search-product">
							...
							<input id="searchSales" name="searchWord" class="form-control" placeholder="Search here..." type="text" value="${paging.searchWord }" autocomplete="off">
							<select name="sex">
						...
						<div class="product-item-filter row">
							<div class="col-12 col-sm-8 text-center text-sm-left">
								<div class="toolbar-sorter-right">
									<span>Sort by </span>
									<select id="basic" name="sort" class="selectpicker show-tick form-control" onchange="sortList()">
									<option data-display="Select" value="">Nothing</option>
									<option value="dt_recept desc" <c:if test="${sort == 'dt_recept desc'}">selected</c:if>>접수일</option>
									<option value="dt_pbl_start desc" <c:if test="${sort == 'dt_pbl_start desc'}">selected</c:if>>공고 시작일</option>
									<option value="dt_pbl_end desc" <c:if test="${sort == 'dt_pbl_end desc'}">selected</c:if>>공고 종료일</option>
								</select>
								</div>
								<p></p>
							</div>
													...
													<div class="col-sm-6 col-md-6 col-lg-4 col-xl-4">
														<div class="products-single fix">
															<div class="box-img-hover">
																<img src="${list.img}" class="img-fluid" alt="Image" style="height:200px;">
															</div>
															<div class="why-text">
