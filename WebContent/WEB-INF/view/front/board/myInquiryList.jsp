...
<head>
	...
	function goPage(value) {
		...
		frmMain.action = "/front/board/myInquiryList.web";
		frmMain.submit();
	}
	</script>
</head>
...
<!-- Start Board Page  -->
<form id="frmMain" method="POST" action="/front/board/myInquiryList.web">
													...
													<div class="row">
														<c:forEach items="${list}" var="list">
															...
															<tr bgcolor="#<c:if test="${trColor == 1}">FFFFFF</c:if><c:if test="${trColor != 1}">F8F8F8</c:if>">
																...
																<a href="/front/board/myInquiryView.web?seq_bbs=${list.seq_bbs}">
