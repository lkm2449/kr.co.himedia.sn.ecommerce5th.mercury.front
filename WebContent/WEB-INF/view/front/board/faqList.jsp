...
<head>
	...
	<script>
		...
		frmMain.action = "/front/board/faqList.web";
		frmMain.submit();
	}
	</script>
</head>
...
<!-- Start Board Page  -->
<form id="frmMain" method="POST" action="/front/board/faqList.web">
				...
				<div class="col-xl-9 col-lg-9 col-sm-12 col-xs-12 shop-content-right">
					<div class="right-product-box">
						<div class="product-item-filter row">
							<h2 style="display: block; width: 100%; text-align: center">자주 찾는 질문</h2>
						</div>
													...
													<div class="row">
														<c:forEach items="${list}" var="list">
															...
															<tr bgcolor="#<c:if test="${trColor == 1}">FFFFFF</c:if><c:if test="${trColor != 1}">F8F8F8</c:if>">
																...
																<a href="/front/board/faqView.web?seq_bbs=${list.seq_bbs}">
