 ...
 *				: [20231128164312][pluto@himedia.co.kr][CREATE: Initial Release]
 */
 ...
 * <p>IMPORTANT:</p>
 */
@Controller("kr.co.himedia.ecommerce.common.controller.SystemCtrl")
public class SystemCtrl {
	...
	public ModelAndView errorProcWeb(HttpServletRequest request, HttpServletResponse response, SystemErrorDto systemErrorDto) {
		...
		try {
			...
			mav.setViewName("/system/error-web");
		}
		catch (Exception e) {
	...
	public ModelAndView rejectProcWeb(HttpServletRequest request, HttpServletResponse response) {
		...
		try {
			...
			mav.setViewName("/system/reject-web");
		}
		catch (Exception e) {
